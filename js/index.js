...
/***/ function(module, exports) {
	...
	(function () {
	  $('.slider__point')[0].checked = true;
	  _setPageBg($('.slider-point')[0]);
...
/***/ function(module, exports) {
	...
	var page = $('html, body');
	var btnFeedback = $('.btn--feedbank');
	var feedback = $('#feedback');
	var btnClose = $('#feedback .icon--close');
	var fieldList = $('#feedback input, #feedback textarea');
	...
	btnClose.click(function () {
	  feedback.removeClass('modal--active');
