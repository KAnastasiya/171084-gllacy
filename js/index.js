...
/***/ function(module, exports) {
	...
	var _setSavedUserInfo = function _setSavedUserInfo() {
	  var lastUserName = localStorage.getItem('user_name');
	  var lastUserEmail = localStorage.getItem('user_email');
	    ...
	    $.each(modalFeedback.fields, function (index, elem) {
	      ...
	      if (!element.val()) {
	        ...
	        if (element.attr('name') === 'user') {
	          ...
	          localStorage.setItem('user_email', element.val());
	        }
	      }
	    });
	  };
